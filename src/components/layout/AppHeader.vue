<template>
  <header class="flex items-center justify-between h-16 px-6 bg-white border-b border-gray-100 shrink-0">
    ...
    <div class="flex-1 max-w-md relative">
      ...
      />
      <span class="absolute inset-y-0 inset-e-3.5 flex items-center text-gray-400 pointer-events-none">
        <Search :size="15" />
      </span>
    </div>
    ...
    <div class="flex items-center gap-2 shrink-0">
      ...
      <button class="relative p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors cursor-pointer">
        <Bell :size="18" />
